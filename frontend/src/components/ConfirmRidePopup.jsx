...
const ConfirmRidePopup = ({ setConfirmRidePopupPanelOpen }) => {
  ...
  return (
    <div className="flex flex-col gap-3">
      <h2 className="text-[28px] text-center font-semibold">Confirm Ride</h2>

      <div className="flex justify-between items-center bg-yellow-500 p-5 rounded-xl">
        <img
        ...
        <h2 className="text-2xl flex flex-col items-end">
          Aryan Tanna <span className="bold-fonts">2.2 KM</span>
        </h2>
      </div>

      <h2 className="text-center text-3xl mt-3 font-semibold">Enter OTP</h2>
      ...
      >
        <div className="flex justify-evenly mb-3">
          {otp.map((num, index) => (
            <input
              key={index}
              className="bg-gray-200 p-3 text-xl rounded-xl w-12 text-center focus:outline-black"
              type="text"
              inputMode="numeric"
              maxLength="1"
              value={num}
        ...
        <button
          ...
          className="inline-block text-center bg-red-600 text-white w-full py-2 text-[22px] rounded-[6px] mt-4"
        >
          Cancel
        </button>
      </form>
