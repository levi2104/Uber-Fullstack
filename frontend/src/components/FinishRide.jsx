...
const FinishRide = ({ setFinishRidePanelOpen, setNavigationPanelOpen }) => {
  return (
    <div className="flex flex-col h-screen gap-3">
      ...
      <h2 className="text-[28px] text-center bold-fonts">
        Finish this ride
      </h2>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="p-6">
          ...
          <p>24B, Near Kapoor&apos;s Cafe, Aryan Coding Hub</p>
